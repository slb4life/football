...
if (isset($_POST['change_page'])) { $change_page = $_POST['change_page']; }
if (isset($_POST['change_opponent'])) { $change_opponent = $_POST['change_opponent']; }
if (isset($_POST['change_player'])) { $change_player = $_POST['change_player']; }
if (isset($_POST['change_manager'])) { $change_manager = $_POST['change_manager']; }
